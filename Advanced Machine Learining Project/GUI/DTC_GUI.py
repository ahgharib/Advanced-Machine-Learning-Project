...
model_path = "D:/Advanced Machine Learining Project/Classification Loan Aproval/Support Vector Machine and Descion Tree Classification/decision_tree.joblib"
...
def open_dtc_window():
    ...
    DTC_window = tk.Toplevel()
    DTC_window.title("DTC Model For Loan Aproval")
    DTC_window.geometry("800x800") 
    DTC_window.minsize(400,400) 
    DTC_window.iconbitmap("/logo.ico")
    DTC_window.configure(bg="pink")

    my_button1 = Button(DTC_window, text="Open CSV", font=("Arial", 15), width=20, bg="red", command=open_csv_file, borderwidth=3, activebackground="blue")
    ...
    scrollable_frame = ScrollableFrame(DTC_window)
